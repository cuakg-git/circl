...
function Logo() {
  return (
    <div className="flex items-center justify-center gap-2.5 mb-9">
      ...
      <span className="text-[1.6rem] font-extrabold text-[#1A1A2E] tracking-tight leading-none">Mhiru</span>
    </div>
  )
}
    ...
    return (
      <div className={pageClass}>
        ...
        <div className="relative z-10 bg-white rounded-3xl w-full mx-4 px-10 py-10 text-center" style={cardStyle}>
          ...
          <div className="mt-4">
            <Link href="/login" className="inline-flex items-center gap-1 text-sm text-[#0A7E8C] font-semibold underline underline-offset-2 hover:opacity-75">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6" /></svg> Volver al login
            </Link>
          </div>
        </div>
      </div>
