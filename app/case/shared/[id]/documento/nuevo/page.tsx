...
export default function NuevoDocumentoSharedPage({
  params,
}: {
  ...
  return (
    <>
      <style>{`
        ...
        .nuevo-doc-shared-bg { animation: heroBgDrift 30s ease-in-out infinite; }
      `}</style>

      <div className="nuevo-doc-shared-bg flex min-h-screen">
        <Sidebar />
            ...
            <div style={{ maxWidth: 480, margin: '0 auto' }}>
              ...
              <div style={{ textAlign: 'center', padding: '16px 0 28px' }}>
                ...
                <p style={{ fontSize: '0.875rem', color: '#5a7478', margin: 0 }}>
                  Subí un archivo para guardarlo en el tema compartido
                </p>
              </div>
